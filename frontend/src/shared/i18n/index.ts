  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        statusEstimatedExhausted: "疑似耗尽",
        estimatedExhaustedTooltip: "本地滚动估算用量已达或超过 Free 上限，选号时会降权或暂不出池；上游确认后转为待重置",
